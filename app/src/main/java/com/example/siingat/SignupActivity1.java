    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etBirth.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                new DatePickerDialog(SignupActivity1.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_other_gender :
                ...
                break;
            case R.id.btn_next :
                Intent introIntent = new Intent(SignupActivity1.this, MainActivity.class);
